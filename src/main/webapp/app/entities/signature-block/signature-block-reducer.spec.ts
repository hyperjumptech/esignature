...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SIGNATUREBLOCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SIGNATUREBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SIGNATUREBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SIGNATUREBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SIGNATUREBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SIGNATUREBLOCK actions', async () => {
      const expectedActions = [
        {
