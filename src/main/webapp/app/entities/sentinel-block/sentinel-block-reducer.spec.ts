...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENTINELBLOCK_LIST actions', async () => {
    ...
    it('dispatches FETCH_SENTINELBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SENTINELBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SENTINELBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SENTINELBLOCK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SENTINELBLOCK actions', async () => {
      const expectedActions = [
        {
