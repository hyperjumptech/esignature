...
import { getEntity, deleteEntity } from './document-participant.reducer';

export const DocumentParticipantDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(documentParticipantEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="esigningApp.documentParticipant.delete.question">
        <Translate contentKey="esigningApp.documentParticipant.delete.question" interpolate={{ id: documentParticipantEntity.id }}>
          Are you sure you want to delete this DocumentParticipant?
        </Translate>
      </ModalBody>
      <ModalFooter>
...
export default DocumentParticipantDeleteDialog;
