...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './document-participant.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTPARTICIPANT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DOCUMENTPARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DOCUMENTPARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DOCUMENTPARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTPARTICIPANT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DOCUMENTPARTICIPANT actions', async () => {
      const expectedActions = [
        {
