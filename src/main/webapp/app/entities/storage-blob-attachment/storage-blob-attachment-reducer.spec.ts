...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './storage-blob-attachment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGEBLOBATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGEBLOBATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGEBLOBATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGEBLOBATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGEBLOBATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGEBLOBATTACHMENT actions', async () => {
      const expectedActions = [
        {
