...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENTFIELD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENTFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENTFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENTFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENTFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENTFIELD actions', async () => {
      const expectedActions = [
        {
