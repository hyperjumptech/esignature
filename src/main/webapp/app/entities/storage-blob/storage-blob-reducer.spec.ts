...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STORAGEBLOB_LIST actions', async () => {
    ...
    it('dispatches FETCH_STORAGEBLOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STORAGEBLOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STORAGEBLOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STORAGEBLOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STORAGEBLOB actions', async () => {
      const expectedActions = [
        {
